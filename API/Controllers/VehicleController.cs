...
namespace API.Controllers
{
    ...
    public class VehicleController(IVehicle vehicle) : ControllerBase
    {
        ...
        public async Task<ActionResult<GeneralResponse>> CreateBrand(CreateVechicleBrandRequestDTO model) =>
            Ok(await vehicle.AddVehicleBrand(model));

        [HttpPost("add-vehicle-owner")]
        public async Task<ActionResult<GeneralResponse>> CreateOwner(CreateVechicleOwnerRequestDTO model) =>
